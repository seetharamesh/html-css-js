...
// function startClick(){
//   var num = document.getElementById("timebox").value;
//   console.log(num);
//   for(var i = 1; i <= num; i++){
//     document.getElementById("circleBlue").innerHTML = i;
//     console.log(i);
//     //do the time count down inside the getelementbyclass.innerhtml of clock
//   }
// }
